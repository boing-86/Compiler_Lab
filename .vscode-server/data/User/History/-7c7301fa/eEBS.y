...
CaseList : CaseList TCASE TINTEGER ':' StmtList	{printf("CaseList -> CaseList case %d : StmtList", $1);}
		| TCASE TINTEGER ':' StmtList			{printf("CaseList -> case %d : StmtList", $1);}
		;

DefaultCase : TDEFAULT ':' StmtList	{printf("default : StmtList");}
			| 						{printf();}
			;
